...
export default function GeneratedTeamsList({
  ...
  return (
    ...
    >
      ...
      <header className="flex flex-col gap-4 p-4 sm:p-6">
        <div className="flex justify-center items-center">
          <h3
            ...
            className="font-semibold leading-none tracking-tight sm:text-lg"
          >
            Generated Teams
          </h3>
        </div>
      ...
      <footer className="flex justify-center gap-4 items-center p-4 sm:p-6 sm:pt-0 pt-0">
        <Button variant="default" aria-label="Share teams" type="button">
          Share
        </Button>
      </footer>
    </section>
